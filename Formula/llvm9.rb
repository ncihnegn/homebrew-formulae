class Llvm9 < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any, catalina: "2f3cd9ad82f3c9f9a4fcdbb79930191caaead9f4ef7ad30ae048c90650b9d932"
  end
  ...
  def install
    ...
    system "install_name_tool", "-change", "@rpath/libLLVM.dylib", install_prefix/"lib/libLLVM.dylib",
install_prefix/"lib/libLTO.dylib"
